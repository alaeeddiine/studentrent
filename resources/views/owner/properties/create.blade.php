...
@section('title', 'Add New Property - StudentRent')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 animate-on-scroll">
            <div class="flex items-center justify-center mb-6">
                ...
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Add New Property</h1>
                    <p class="text-gray-600">Create a new student rental listing and reach thousands of students</p>
                </div>
            </div>
        </div>
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        previewContainer.innerHTML = `
                            <p class="text-sm font-medium text-gray-700 mb-3">Image Preview:</p>
